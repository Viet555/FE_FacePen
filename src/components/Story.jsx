    ...
    return (
        <div className="story-container">
            ...
            <div className="story-scroll" ref={scrollRef}>
                <div className="story-create" onClick={handleOpen}>
                ...
                {stories.map((story, index) => (
                    <div className="story-card" key={story.id} onClick={() => handleOpen(story)}>
            ...
            <button className="scroll-btn right" onClick={scrollRight}><i className="fa-solid fa-chevron-right"></i></button>
            {selectedStory && (
