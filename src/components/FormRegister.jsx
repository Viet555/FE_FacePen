...
const FormRegister = () => {
    ...
    return (
        <form onSubmit={handleSubmit} action="register" className="form-register">
            ...
            <div className="input-form">
                <input type={hidenPassword === false ? "password" : "text"} name="password" id="password" className="input" placeholder="Enter your Password" value={formRegister.password} onChange={(e) => setFormRegister({ ...formRegister, password: e.target.value})}/>
            ...
            <p className="p">You have a account? <span className="sign-up"><Link to={"/login"}>Sign in</Link></span></p>
